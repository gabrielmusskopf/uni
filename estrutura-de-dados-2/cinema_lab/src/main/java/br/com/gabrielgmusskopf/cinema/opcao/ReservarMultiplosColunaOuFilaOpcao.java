...
class ReservarMultiplosColunaOuFilaOpcao extends OpcaoAbstrata {

	private static final int A_ASCII = 65;

	public ReservarMultiplosColunaOuFilaOpcao(int numero, Cinema cinema, Grafico grafico) {
	...
	public String getFrase() {
		return "Reservar múltiplos em uma coluna ou fila";
	}
